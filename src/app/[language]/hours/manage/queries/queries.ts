...
import { EpsNestjsOrpEffCicliEsecFilterType, EpsNestjsOrpEffCicliEsecSortType, OthersFiltersType } from "../user-filter-types";
...
export const epsNestjsOrpEffCicliEsecQueryKeys = createQueryKeys(["EpsNestjsOrpEffCicliEsec"], {
  list: () => ({
    key: [],
    sub: {
      by: ({
